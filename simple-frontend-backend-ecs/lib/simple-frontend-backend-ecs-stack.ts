...
export class SimpleFrontendBackendEcsStack extends cdk.Stack {
  constructor(scope: cdk.Construct, id: string, props?: cdk.StackProps) {
    ...
    const vpc = new ec2.Vpc(this, "SimpleFeBeVpc", { maxAzs: 2 });
    ...
    const feSvc = new ecs_patterns.NetworkLoadBalancedFargateService(this, "FeSvc", {
      serviceName: "frontend",               // feService
      cluster: cluster,
      cloudMapOptions: { name: "frontend" }, // feService
      cpu: 512,
      desiredCount: 2,
    ...
    const beContainer = beTaskDef.addContainer("backend", {
    ...
    const beSvc = new ecs_patterns.NetworkLoadBalancedFargateService(this, "BeSvc", {
      serviceName: "backend",               // beService
      cluster: cluster,
      cloudMapOptions: { name: "backend" }, // beService
      cpu: 512,
      desiredCount: 2,
